...
table.replace([1, 3, 5], ("New value")) # Replaces data at list index 1, 3, and five with "New value" (please note that indexes are added by one as per Python's default indexing guidelines.  For example, first item in table is at index zero).
